    ...
    <div className="p-6 max-w-6xl">
      ...
      <div className="bg-zinc-950/50 border border-zinc-800/60 rounded-lg p-4 mb-4 animate-fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <div>
            <label className="text-[11px] text-zinc-500 mb-1 block">Prazo a partir de</label>
            <input
              type="date"
              value={dueDateFrom}
          ...
          <div>
            <label className="text-[11px] text-zinc-500 mb-1 block">Prazo até</label>
            <input
              type="date"
              value={dueDateTo}
      ...
      <div className="bg-zinc-950/50 border border-zinc-800/60 rounded-lg">
        {loading ? (
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-sm text-zinc-500">Nenhuma tarefa encontrada com os filtros selecionados</p>
          </div>
        ) : (
            ...
            {filtered.map(task => {
              ...
              return (
                <div key={task.id} className="flex items-center justify-between px-4 py-3 hover:bg-zinc-900/40 transition-colors">
                  ...
                  <span className="text-[11px] text-zinc-500 bg-zinc-800/60 px-2 py-0.5 rounded-full ml-2">
